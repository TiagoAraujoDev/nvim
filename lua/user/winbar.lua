...
-- Highlight winbar
vim.api.nvim_set_hl(0, "NavicIconsNamespace", { fg = "#2c8bb8"})
vim.api.nvim_set_hl(0, "NavicIconsEnum", { fg = "#e5c07b"})
vim.api.nvim_set_hl(0, "NavicIconsEnumMember", { fg = "#e36c39"})
vim.api.nvim_set_hl(0, "NavicIconsKey", { fg = "#98c379"})
vim.api.nvim_set_hl(0, "NavicIconsPackage", { fg = "#98c379"})
...
vim.api.nvim_set_hl(0, "NavicIconsOperator", { fg = "#be5046"})
...
vim.api.nvim_set_hl(0, "NavicIconsConstant", { fg = "#be5046"})
vim.api.nvim_set_hl(0, "NavicIconsNumber", { fg = "#e3ae1e"})
vim.api.nvim_set_hl(0, "NavicIconsClass", { fg = "#98c379"})
vim.api.nvim_set_hl(0, "NavicIconsBoolean", { fg = "#e36c39"})
vim.api.nvim_set_hl(0, "NavicIconsArray", { fg = "#e3ae1e"})
vim.api.nvim_set_hl(0, "NavicIconsModule", { fg = "#e06c75"})
vim.api.nvim_set_hl(0, "NavicText", { fg = "#565c64", bg = "none"})
vim.api.nvim_set_hl(0, "NavicIconsMethod", { fg = "#be5046"})
vim.api.nvim_set_hl(0, "NavicIconsVariable", { fg = "#1151ab"})
vim.api.nvim_set_hl(0, "NavicIconsFunction", { fg = "#e06c75"})
vim.api.nvim_set_hl(0, "NavicIconsObject", { fg = "#e06c75"})
vim.api.nvim_set_hl(0, "NavicIconsString", { fg = "#98c379"})
